...
describe('GetConversationsUseCase', () => {
  ...
  describe('execute', () => {
    it('should return all conversations sorted by updatedAt descending', async () => {
      ...
      vi.mocked(mockConversationRepository.findAll).mockResolvedValue([conversation1, conversation2])
    ...
    it('should handle repository errors', async () => {
      // Arrange
      vi.mocked(mockConversationRepository.findAll).mockRejectedValue(new Error('Database error'))
    ...
    it('should convert domain entities to DTOs correctly', async () => {
      ...
      vi.mocked(mockConversationRepository.findAll).mockResolvedValue([conversation])
  ...
  describe('error handling', () => {
    it('should log errors for debugging', async () => {
      ...
      vi.mocked(mockConversationRepository.findAll).mockRejectedValue(new Error('Database connection failed'))
      ...
      // Assert
      expect(consoleSpy).toHaveBeenCalledWith('GetConversationsUseCase error:', {
    ...
    it('should handle unknown error types', async () => {
      // Arrange
      vi.mocked(mockConversationRepository.findAll).mockRejectedValue('String error')
