...
describe('Message', () => {
  ...
  describe('constructor', () => {
    it('should create a message with valid parameters', () => {
      const message = new Message(messageId, 'Hello world', MessageRole.USER, timestamp)
    ...
    it('should throw error for empty content', () => {
      expect(() => new Message(messageId, '', MessageRole.USER, timestamp))
    ...
    it('should throw error for null content', () => {
      expect(() => new Message(messageId, null as any, MessageRole.USER, timestamp))
        .toThrow('Message content cannot be empty')
    })

    it('should throw error for undefined content', () => {
      expect(() => new Message(messageId, undefined as any, MessageRole.USER, timestamp))
        .toThrow('Message content cannot be empty')
    })
  })
  ...
  describe('isFromUser', () => {
    it('should return true for user messages', () => {
      const message = new Message(messageId, 'Hello', MessageRole.USER, timestamp)
      expect(message.isFromUser()).toBe(true)
    })

    it('should return false for assistant messages', () => {
      const message = new Message(messageId, 'Hello', MessageRole.ASSISTANT, timestamp)
  ...
  describe('equals', () => {
    it('should return true for messages with same id', () => {
      const message1 = new Message(messageId, 'Hello', MessageRole.USER, timestamp)
      const message2 = new Message(messageId, 'Different content', MessageRole.ASSISTANT, new Date())
    ...
    it('should return false for messages with different ids', () => {
      const message1 = new Message(messageId, 'Hello', MessageRole.USER, timestamp)
      const message2 = new Message(new MessageId('different-id'), 'Hello', MessageRole.USER, timestamp)
  ...
  describe('createUserMessage', () => {
    ...
    it('should validate content', () => {
      expect(() => Message.createUserMessage(''))
        .toThrow('Message content cannot be empty')
    })
  })
  ...
  describe('createAssistantMessage', () => {
    ...
    it('should validate content', () => {
      expect(() => Message.createAssistantMessage(''))
        .toThrow('Message content cannot be empty')
    })
  })
})