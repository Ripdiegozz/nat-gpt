...
describe('Conversation', () => {
  ...
  beforeEach(() => {
    ...
    message2 = new Message(new MessageId('msg-2'), 'Hi there!', MessageRole.ASSISTANT)
  ...
  describe('constructor', () => {
    ...
    it('should create conversation with empty messages array by default', () => {
      const conversation = new Conversation(conversationId, 'Test Conversation')
    ...
    it('should use current date for timestamps if not provided', () => {
      ...
      expect(conversation.createdAt.getTime()).toBeGreaterThanOrEqual(beforeCreation.getTime())
      expect(conversation.createdAt.getTime()).toBeLessThanOrEqual(afterCreation.getTime())
      expect(conversation.updatedAt.getTime()).toBeGreaterThanOrEqual(beforeCreation.getTime())
      expect(conversation.updatedAt.getTime()).toBeLessThanOrEqual(afterCreation.getTime())
    })
    ...
    it('should throw error for empty title', () => {
      expect(() => new Conversation(conversationId, ''))
    ...
    it('should throw error for null title', () => {
      expect(() => new Conversation(conversationId, null as any))
        .toThrow('Conversation title cannot be empty')
    })

    it('should throw error for undefined title', () => {
      expect(() => new Conversation(conversationId, undefined as any))
        .toThrow('Conversation title cannot be empty')
    })
  })
  ...
  describe('addMessage', () => {
    it('should return new conversation with added message', () => {
      const conversation = new Conversation(conversationId, 'Test Conversation', [message1])
      ...
      expect(newConversation.updatedAt.getTime()).toBeGreaterThanOrEqual(conversation.updatedAt.getTime())
    })
  ...
  describe('getMessages', () => {
    it('should return readonly array of messages', () => {
      const conversation = new Conversation(conversationId, 'Test Conversation', [message1, message2])
  ...
  describe('equals', () => {
    it('should return true for conversations with same id', () => {
      const conversation1 = new Conversation(conversationId, 'Test Conversation 1', [message1])
      const conversation2 = new Conversation(conversationId, 'Test Conversation 2', [message2])
      
      expect(conversation1.equals(conversation2)).toBe(true)
    })

    it('should return false for conversations with different ids', () => {
      const conversation1 = new Conversation(conversationId, 'Test Conversation')
      const conversation2 = new Conversation(new ConversationId('different-id'), 'Test Conversation')
  ...
  describe('create', () => {
    ...
    it('should create conversation with provided id', () => {
      const conversation = Conversation.create('My Conversation', conversationId)
