  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-base text-sm font-base ring-offset-white transition-all gap-2 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 touch-manipulation",
  {
    variants: {
      variant: {
        ...
        noShadow:
          "text-main-foreground bg-main border-2 border-border active:scale-95",
        neutral:
      ...
      size: {
        ...
        sm: "h-9 px-3 text-xs min-w-[2rem]",
        lg: "h-11 px-8 text-base min-w-[3rem]",
        icon: "size-10 min-w-[2.5rem] min-h-[2.5rem] p-0",
      },
    },
    defaultVariants: {
      variant: "default",
